            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if($staff->isSuper==true): ?>
                            <a href="/Staff/<?php echo e($staff->id); ?>/delete" class="btn disabled btn-lg btn-danger pull-right">Remove this member</a>
                        <?php else: ?>
                            <a href="/Staff/<?php echo e($staff->id); ?>/delete" class="btn btn-lg btn-danger pull-right">Remove this member</a>
                        <?php endif; ?>
                        <h4 class="text-center">Edit staff details</h4>

                        <hr>
                        <form method="post" enctype="multipart/form-data" action="/Staff/<?php echo e($staff->id); ?>/update">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($staff->email); ?>" type="email" class="form-control" id="register_email" name="email" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($staff->name); ?>" type="text" class="form-control" id="register_name" name="name" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($staff->staffID); ?>" type="text" class="form-control" id="register_stuid" name="staffid" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($staff->department); ?>" type="text" class="form-control" id="register_deptno" name="department" />
                                    </div>
                                </div>
                                <div class="col-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="job_title">Job Title </label>
                                        <input value="<?php echo e($staff->job_title); ?>" type="text" class="form-control" id="job_title" name="job_title" />
                                    </div>
                                </div>
                            </div>
